      ...
      <div ref={workRef} className="min-h-screen bg-white text-black py-24 lg:py-40 overflow-hidden">
        ...
        <div className='main-container pb-8 lg:pb-12 flex max-md:flex-col gap-6 justify-between items-start md:items-end'>
          <div className='max-w-xl'>
            ...
            <p className='text-lg lg:text-xl'>A showcase of my selected projects—designed and develop to inspire, engage, and deliver real results.</p>
          </div>
          <Link to="/projects">
          <GradientButton text="Explore All"  className="btn-light" />
          </Link>
        </div>
        <div ref={projectsRef}>
          {/* Projects */}
