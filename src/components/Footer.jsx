  ...
  return (
    <>
      ...
      <footer className="main-container grid md:grid-cols-2 lg:grid-cols-4 gap-10 py-20">
        ...
        <div>
          ...
          <ul className='flex flex-col gap-2 text-base lg:text-lg'>
            ...
            <li><a href="">Enturepranure</a></li>
          </ul>
        </div>
        <div>
          <h5 className='font-medium mb-5'>Accessibility</h5>
          <ul className='flex flex-col gap-2 text-base lg:text-lg'>
            <li>sun - saturday: 9:00 - 5:00</li>
      ...
      <div className='main-container grid md:grid-cols-2 gap-3 py-6 lg:py-8 max-md:text-center'>
        <div className='text-base lg:text-lg'>© 2025 Ray | All rights reserved</div>
        <div className='flex gap-3 justify-center md:justify-end'>
          <a href="https://www.linkedin.com/in/tirthoray10/" target="_blank" rel="noopener noreferrer">
          ...
          <a href="https://wa.me/8801752900881" target="_blank" rel="noopener noreferrer">
          <svg width="30" height="30" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M20.52 3.48C18.18 1.14 14.82 0 11.37 0 5.1 0 0 5.1 0 11.37c0 2.01.53 3.93 1.53 5.64L0 24l7.09-1.49C9.78 23.47 10.95 24 12.13 24c6.27 0 11.37-5.1 11.37-11.37 0-3.45-1.14-6.81-3.98-9.15zM12.13 21.57c-1.09 0-2.16-.29-3.11-.84l-.22-.13-4.21.88.89-4.11-.14-.22a9.17 9.17 0 01-1.42-4.95c0-5.01 4.08-9.1 9.1-9.1 2.42 0 4.7.95 6.41 2.66a9.066 9.066 0 012.67 6.41c0 5.01-4.08 9.1-9.1 9.1zm5.02-7.3c-.27-.14-1.61-.79-1.85-.88-.24-.09-.41-.14-.58.14-.17.27-.66.88-.81 1.06-.15.17-.3.19-.56.07-.27-.13-1.14-.42-2.18-1.35-.81-.72-1.36-1.61-1.52-1.88-.16-.27-.02-.42.12-.56.12-.12.27-.3.41-.45.14-.15.18-.25.27-.42.09-.17.05-.32-.02-.45-.07-.12-.58-1.39-.8-1.91-.21-.5-.43-.43-.58-.44-.15-.01-.32-.01-.49-.01-.17 0-.45.06-.69.32-.24.26-.92.9-.92 2.2 0 1.3.94 2.56 1.07 2.73.13.17 1.85 2.83 4.5 3.87.63.27 1.12.43 1.5.55.63.2 1.2.17 1.65.1.5-.08 1.61-.66 1.84-1.3.23-.64.23-1.18.16-1.3-.07-.12-.27-.19-.58-.33z" fill="green"/>
          </svg>
        </a>

          <a href="https://www.facebook.com/tirtho.ray.935187" target="_blank" rel="noopener noreferrer">
            <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
           ...
           <a href="https://www.instagram.com/tirtho_ray10/" target="_blank" rel="noopener noreferrer"> 
            <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
